...
<script>
    ...
    $(function () {
        ...
        table.bootstrapTable({
            ...
            url: "/admin/market_godown/info", //获取数据的Servlet地址
            ajaxOptions:{
