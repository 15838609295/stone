    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form class="deleteForm" method="POST" action="/admin/goods">
...
<script>
    $(function () {
        ...
        table.bootstrapTable({
            ...
            url: "/admin/permission/index", //获取数据的Servlet地址
            ajaxOptions:{
            ...
            columns: [[
                ...
                {field:'updated_at', title: '更新时间',sortable: true},
                {
                    ...
                    formatter: function (value, row, index) {
                        var html ='';
                        @if($cid==0)
                        html += ' <a href="/admin/permission/' + row['id'] + '" class="btn btn-xs btn-info btn-delone" title="下级菜单"><i class="fa fa-server"></i> </a>';
                        @endif
                        html += ' <a href="/admin/permission/' + row['id'] + '/edit" class="btn btn-xs btn-success btn-editone" title="编辑"><i class="fa fa-pencil"></i> </a> ';
