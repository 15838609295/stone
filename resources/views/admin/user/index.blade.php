            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div class="bootstrap-table">
                    	<!--  工具栏     
                    	<div id="toolbar">
                    		<a class="btn btn-success" href="/admin/user/create" title="添加">
...
<script>
    ...
    $(function () {
        ...
        table.bootstrapTable({
            ...
            url: "/admin/user/index", //获取数据的Servlet地址
            ajaxOptions:{
            ...
            columns: [[
                ...
                {field:'email', title: '邮箱'},
                {
                    ...
                    formatter: function (value, row, index) {
                        var html ='';
                        html += '<a href="/admin/user/' + row['id'] + '/edit" title="修改" class="btn btn-xs btn-success btn-editone"><i class="fa fa-pencil"></i> </a> ';
                        
                        //html += '<a href="#" attr="' + row['id'] + '" title="删除" class="btn btn-xs btn-danger btn-delone delBtn"><i class="fa fa-trash"></i> </a>';
                        return html;
                    }
                }
            ]]
