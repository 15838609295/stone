...
@section('pageDesc')
<a href="/admin/company/index">企业管理</a>  >>  <a href="/admin/company/{{$id}}/sales">{{$name}}</a>
@stop
...
<script>
    ...
    $(function () {
        ...
        table.bootstrapTable({
            ...
            url: "/admin/company/{{$id}}/sales", //获取数据的Servlet地址
            ajaxOptions:{
            ...
            columns: [[
                {field:'goods_attr_name', title: '产品名称'},
                {
                    ...
                    formatter: function (value, row, index) {
                        return row['sale_weight_h']+' m³';
                    }
                },
                {field:'sale_count_h', title: '荒料订单数量',sortable: true},
                {
                    field:'month_j_h',
                    title: '本月荒料均售',
                    sortable: true,
                    formatter: function (value, row, index) {
                        if(row['goods_attr_name']=='合计'){
                            return ' -  ';
                        }
                        if(row['month_j_h']==null){
                            return '0元/m³';
                        }
                        return row['month_j_h']+'元/m³';
                    }
                },
                {
                    field:'total_j_h',
                    ...
                    formatter: function (value, row, index) {
                        ...
                        if(row['total_j_h']==null){
                            return '0元/m³';
                        }
                        return row['total_j_h']+'元/m³';
                    }
                },
                {
                    field:'sale_weight_d',
                    ...
                    sortable: true,
                    formatter: function (value, row, index) {
                        return row['sale_weight_d']+' ㎡';
                    }
                },
                {field:'sale_count_d', title: '大板订单数量',sortable: true},
                {
                    field:'month_j_d',
                    title: '本月大板均售',
                    sortable: true,
                    formatter: function (value, row, index) {
                        ...
                        if(row['month_j_d']==null){
                            return '0元/m³';
                        }
                        return row['month_j_d']+'元/㎡';
                    }
                },
                {
                    field:'total_j_d',
                    ...
                    formatter: function (value, row, index) {
                        ...
                        if(row['total_j_d']==null){
                            return '0元/m³';
                        }
                        return row['total_j_d']+'元/㎡';
                    }
                },
                {
                  field:'money_month',
