...
@section('pageDesc',"<a href="/admin/company/index">企业管理</a>  >>  <a href="/admin/company/$id/users">$name</a>")
...
<script>
    ...
    $(function () {
        ...
        table.bootstrapTable({
            ...
            url: "/admin/company/{{$id}}/users", //获取数据的Servlet地址
            ajaxOptions:{
            ...
            columns: [[
                ...
                {field:'cur_month_d', title: '本月登录',sortable: true,},
                {field:'last_month_d', title: '上月登录',sortable: true,},
                {field:'total_d', title: '总登录',sortable: true,},
                {field:'cur_month_c', title: '本月操作',sortable: true,},
                {field:'last_month_c', title: '上月操作',sortable: true,},
                {field:'total_c', title: '总操作',sortable: true,},
                {field:'total_j_d', title: '月均登录',sortable: true,},
                {field:'total_j_c', title: '月均操作',sortable: true,}
            ]]
        });
