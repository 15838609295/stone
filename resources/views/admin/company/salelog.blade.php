...
@section('pageDesc')
<a href="/admin/company/index">企业管理</a>  >>  <a href="/admin/company/{{$id}}/salelog">{{$name}}</a>
@stop
...
<script>
    ...
    $(function () {
        ...
        table.bootstrapTable({
            ...
            url: "/admin/company/{{$id}}/salelog", //获取数据的Servlet地址
            ajaxOptions:{
            ...
            columns: [[
                {field:'cur_time', title: '时间'},
                {
                    field:'weight_h',
                    title: '荒料售出数量',
                    formatter: function (value, row, index) {
                        return row['weight_h']+' m³';
                    }
                },
                {
                    field:'sale_total_price_h',
                    title: '荒料售出金额',
                    formatter: function (value, row, index) {
                        return row['sale_total_price_h']+' 元';
                    }
                },
                {field:'order_number_h', title: '荒料售出订单数'},
                {
                    field:'price_j_h',
                    title: '荒料均售价',
                    formatter: function (value, row, index) {
                ...
                },
                {
                    ...
                    title: '大板售出数量',
                    formatter: function (value, row, index) {
                        return row['weight_d']+'m²';
                    }
                },
                {
                    field:'sale_total_price_d',
                    title: '大板售出金额',
                    formatter: function (value, row, index) {
                        return row['sale_total_price_d']+' 元';
                    }
                },
                {field:'order_number_d', title: '大板售出订单数'},
                {
                    field:'price_j_d',
                    title: '大板均售价',
                    formatter: function (value, row, index) {
